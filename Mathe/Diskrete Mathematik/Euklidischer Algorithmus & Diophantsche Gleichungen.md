...
Wenn $e$ und $m$ teilerfremd sind, dann ist die Lösung der [diophantischen Gleichung](#Diophantische%20Gleichung) $e * x + m * y = 1$ das multiplikative Invers $\frac{1}{e}$ in $\mathbb{Z}_m$ 
